      ...
      <div ref={ref} className="relative">
        ...
        {open && (
          <>
            ...
            <div className="absolute left-0 right-0 top-full z-50 mt-1 overflow-y-auto rounded-xl border border-gray-200 backdrop-blur-sm bg-white/90 shadow-lg" style={{ maxHeight: "250px" }}>
              {options.map((opt) => (
                <button
                  key={opt.value}
                  type="button"
