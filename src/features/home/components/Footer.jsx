...
const Footer = () => {
  ...
  return (
    <footer className="mt-16 bg-sec text-white">
      <div className="w-[90%] m-auto px-6 lg:px-0 py-14">
        <div className="grid gap-12 lg:grid-cols-4">
          <div>
            <img src={logo} alt="Medicard" className="h-10 w-auto" />
        ...
        <div className="mt-12 border-t border-white/15 pt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between text-xs text-white/70">
